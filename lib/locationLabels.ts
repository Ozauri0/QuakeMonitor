...
export const CHILE_LOCATIONS: LocationLabel[] = [
  ...
  // Regions — centroids placed well inland to avoid ocean overlap
  { name: "Arica y Parinacota", lat: -18.55, lng: -69.60, type: "region", importance: 6 },
  { name: "Tarapacá", lat: -20.35, lng: -68.90, type: "region", importance: 6 },
  { name: "Antofagasta", lat: -23.65, lng: -68.80, type: "region", importance: 6 },
  { name: "Atacama", lat: -27.10, lng: -69.40, type: "region", importance: 6 },
  { name: "Coquimbo", lat: -29.90, lng: -70.60, type: "region", importance: 6 },
  { name: "Valparaíso", lat: -32.40, lng: -70.90, type: "region", importance: 7 },
  { name: "Metropolitana", lat: -33.45, lng: -70.35, type: "region", importance: 8 },
  { name: "O'Higgins", lat: -34.35, lng: -70.55, type: "region", importance: 6 },
  { name: "Maule", lat: -35.60, lng: -71.30, type: "region", importance: 6 },
  { name: "Ñuble", lat: -36.50, lng: -71.90, type: "region", importance: 6 },
  { name: "Biobío", lat: -37.10, lng: -72.10, type: "region", importance: 7 },
  { name: "La Araucanía", lat: -38.80, lng: -72.10, type: "region", importance: 6 },
  { name: "Los Ríos", lat: -39.90, lng: -72.90, type: "region", importance: 6 },
  { name: "Los Lagos", lat: -41.40, lng: -72.60, type: "region", importance: 6 },
  { name: "Aysén", lat: -46.10, lng: -72.40, type: "region", importance: 5 },
  { name: "Magallanes", lat: -52.10, lng: -71.30, type: "region", importance: 5 },
];
